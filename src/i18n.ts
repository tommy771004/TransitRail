  ...
  'zh-TW': {
    translation: {
      ...
      search: {
        ...
        about_body: "TransitRail 是免費的跨國鐵道與大眾運輸查詢工具，整合日本、新加坡、馬來西亞、泰國、香港、英國、美國、德國、法國、比利時、挪威、瑞士與中國共 13 個國家及地區。馬來西亞目前僅使用官方歷史運量資料建立每日更新的站點目錄，絕不標示為時刻表或即時到站資料。",
  ...
  ja: {
    translation: {
      ...
      search: {
        ...
        about_body: "TransitRailは、日本、シンガポール、マレーシア、タイ、香港、イギリス、アメリカ、ドイツ、フランス、ベルギー、ノルウェー、スイス、中国の13の国と地域の鉄道・地下鉄網を統合した、無料の国際鉄道・公共交通時刻表検索サービスです。マレーシアは現在、公式の過去乗車実績に基づく駅一覧のみを提供しており、時刻表やリアルタイム到着情報としては表示していません。",
  ...
  ko: {
    translation: {
      ...
      search: {
        ...
        about_body: "TransitRail은 일본, 싱가포르, 말레이시아, 태국, 홍콩, 영국, 미국, 독일, 프랑스, 벨기에, 노르웨이, 스위스, 중국 등 13개국의 철도 및 지하철 네트워크를 통합한 무료 국제 열차·대중교통 시간표 검색 서비스입니다. 말레이시아는 현재 공식 과거 이용 실적 데이터를 기반으로 한 역 목록만 제공하며, 시간표나 실시간 도착 정보로 표시되지 않습니다.",
