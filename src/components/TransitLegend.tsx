      ...
      sections: [
        {
          ...
          lines: [
            ...
            { name: t("legend.hk_is", { defaultValue: "Island Line (港島綫)" }), color: "#007FFF" },
            { name: t("legend.hk_kt", { defaultValue: "Kwun Tong Line (觀塘綫)" }), color: "#00A650" },
            { name: t("legend.hk_er", { defaultValue: "East Rail Line (東鐵綫)" }), color: "#53C7EC" },
            { name: t("legend.hk_tm", { defaultValue: "Tuen Ma Line (屯馬綫)" }), color: "#9A3820" },
            { name: t("legend.hk_ae", { defaultValue: "Airport Express (機場快綫)" }), color: "#1C7670" },
          ],
        },
        {
          ...
          lines: [
            ...
            { name: t("legend.uk_vic", { defaultValue: "Victoria Line" }), color: "#00A4E4" },
            { name: t("legend.uk_jub", { defaultValue: "Jubilee Line" }), color: "#868F98" },
            { name: t("legend.uk_central", { defaultValue: "Central Line" }), color: "#E32017" },
            { name: t("legend.uk_eliz", { defaultValue: "Elizabeth Line" }), color: "#743B8F" },
            { name: t("legend.uk_dlr", { defaultValue: "DLR (Docklands Light Railway)" }), color: "#00A4A6" },
          ],
        },
        {
        ...
        },
        {
          ...
          lines: [
            ...
            { name: t("legend.kr_l1", { defaultValue: "Line 1 (1號線)" }), color: "#003DA5" },
            { name: t("legend.kr_l2", { defaultValue: "Line 2 (2號線)" }), color: "#37b42c" },
            { name: t("legend.kr_l3", { defaultValue: "Line 3 (3號線)" }), color: "#ef7c1c" },
            { name: t("legend.kr_l4", { defaultValue: "Line 4 (4號線)" }), color: "#00a5df" },
            { name: t("legend.kr_l9", { defaultValue: "Line 9 (9號線)" }), color: "#b99f1d" },
          ],
        },
      ],
    },
