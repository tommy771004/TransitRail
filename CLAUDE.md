...
The metro integrity work applies the stricter no-page gate to the eight representative Singapore/Thailand metro snapshots: those route pages are omitted and redirected to the localized `/routes/` index. Intercity and high-speed route pages keep the existing service-window/SEO contract because their presentation is outside this spec's scope.
